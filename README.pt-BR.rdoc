= Git-Webby - Web mais esperta para o Git

{<img src="https://badge.fury.io/rb/git-webby.svg" alt="Gem Version" />}[https://badge.fury.io/rb/git-webby]
...
O objetivo principal do <b>Git-Webby</b> é implementar as seguintes
funcionalidades:
...
Instale o Git-Webby usando {Rubygems}[http://rubygems.org/gems/git-webby].

  gem install git-webby

Ou faça um _checkout_ do projeto hospedado no
{Github}[http://github.com/codigorama/git-webby].
...
O Git-Webby está em desenvolvimento, então ainda há muitas melhorias a serem
feitas. Por favor, nos ajude a melhorar o projeto enviando seu comentário nos
{problemas}[http://github.com/codigorama/git-webby/issues] encontrados ou
enviando um email para
{opensource@codigorama.com}[mailto:opensource@codigorama.com].

Discuta no {Google Groups}[http://groups.google.com/group/git-webby].

== AUTORES

Escrito por Hallison Batista <hallison@codigorama.com>.

== ERROS

Se você encontrar um erro, por favor, informe no
{gerenciador de erros}[http://github.com/codigorama/git-webby] do projeto
Git-Webby no Github.

== LICENÇA

Git-Webby é Copyright (c) 2011 Hallison Batista, Codigorama.
